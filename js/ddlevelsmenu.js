...
arrowpointers:{
	//downarrow: ["menutop_files/arrow-down.gif", 0,0], //[path_to_down_arrow, arrowwidth, arrowheight]
	//rightarrow: ["menutop_files/arrow-right.gif", 0,0], //[path_to_right_arrow, arrowwidth, arrowheight]
