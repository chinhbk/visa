<?php
	...
	class Application_Model_BookVisaMapper{
		...
		public function search($keyword=null)
		{
		    try{
		        $select = $this->_db_table->select()
		        ->from(array('b' => self::TABLE), array('ID', 'CODE', 'PURPOSE_OF_VISIT', 'VISA_TYPE_ID', 'PROCESSING_TIME_TYPE_ID', 'VISA_LETTER', 'NUMBER_OF_VISA', 'TOTAL_PRICE', 'ARRIVAL_DATE', 'ARRIVAL_AIRPORT', 'CONTACT_NAME', 'CONTACT_EMAIL', 'CONTACT_PHONE', 'STATUS', 'TRANS_CODE', 'TRANS_NUMBER', 'UPDATE_DATE'))
