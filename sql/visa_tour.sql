...
ALTER TABLE `BOOK_TOUR` ADD `TOTAL_PRICE` VARCHAR(100) NULL AFTER `NO`;
ALTER TABLE `BOOK_TOUR` ADD `TOUR_PRICE_GROUP_ID` INT NULL AFTER `TOUR_ID`;
ALTER TABLE `BOOK_TOUR` CHANGE `UPDATE_DATE` `UPDATE_DATE` DATETIME NULL DEFAULT NULL;
ALTER TABLE `BOOK_TOUR` CHANGE `CREATE_DATE` `CREATE_DATE` DATETIME NULL DEFAULT NULL;